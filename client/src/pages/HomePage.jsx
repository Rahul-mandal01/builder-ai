...
const HomePage = () => {
  ...
  return (
    <div className="h-screen overflow-y-scroll text-white font-sans 
    bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat ">
      {/* Navbar */}
      <nav className="sticky top-0 z-10 flex items-center justify-between
        ...
        text-zinc-300">
          <span>{user?.name}</span>
          <button className="py-1.5 px-3 border border-white/20 text-white hover:bg-white/10
          text-sm rounded-md cursor-pointer bg-transparent">
            Sign out
          </button>
        </div> 
      </nav>
      ...
      xl:mt-28">
        ...
        <div className="flex flex-col items-center max-w-2xl w-full">
          ...
          backdrop-blur-md rounded-full border border-white/20 text-[13px]
          text-white/90">
            <span className="px-3 py-1 text-[11px] bg-red-700 rounded-full
            font-medium tracking-wider">PROMO</span>
